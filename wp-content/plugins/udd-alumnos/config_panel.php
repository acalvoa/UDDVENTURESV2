...
<div class="wrap">
    <div class="titulo">
    <?php    echo "<h2><i class='fa fa-cog'></i>  " . __( 'Configuraciónes de la pagina UDD Ventures Alumnos', 'udd_alumnos' ) . "</h2>"; ?>
    </div>
    <div class="formulario">
      <form action="options.php" method="post">
          <div class="imagenes">
            ...
            <?php 
                settings_fields('UDD_alumnos_settings');
                do_settings_sections('UDD_alumnos_settings');
            ?>
            <p>
              <label for="landing-loader">Imagen de Portada</label><br>
              <input type="text" name="landing-img" value="<?php echo get_alumnos_image();?>">
