...
add_action('init', 'create_noticias'); // Add our HTML5 Blank Custom Post Type
add_action('init', 'create_nosotros'); // Add our HTML5 Blank Custom Post Type
add_action('init', 'create_quiensomos'); // Add our HTML5 Blank Custom Post Type
...
function create_quiensomos() {
    register_post_type( 'quiensomos',
        array(
          'labels' => array(
        ...
        'public' => true,
        'menu_position' => 8,
        'rewrite' => array( 'slug' => 'quiensomos' ),
        'capability_type'     => 'page',
        'has_archive' => true,
        )
    );
    register_taxonomy( 'quiensomos-tipo',
        'quiensomos',
        array(
          'hierarchical' => false,
          'label'        => __( 'Tipo' ),
          'rewrite'      => array( 'slug' => 'quiensomos-tipo' )
        )
    );
}
/* ADMIN PANEL */
...
//AGREGAMOS LAS OPCIONES DEL THEME
require_once( 'themes-options.php' );
...
function FESaddpost_id($document, $post){
    ...
    $document['_source']['site']['id'] = "www.uddventures.cl";
    $document['_source']['site']['url'] = "http://www.uddventures.cl";
    $document['_source']['site']['name'] = "UDD Ventures - Landing Page";
