...
<html <?php language_attributes(); ?> class="no-js" lang="es">
	...
	<?php 
		$url = URL_();
		if(strpos($url, '/alumnos/postulaciones') === 0){ //LISTO
			include(dirname(__FILE__)."/../UDDBASESTYLE/partial/header_w.php"); 
		}
		...
		else if(strpos($url, '/alumnos/noticias') === 0){ //LISTO
			include(dirname(__FILE__)."/../UDDBASESTYLE/partial/header_w.php"); 
		}
		...
		{
			include(dirname(__FILE__)."/../UDDBASESTYLE/partial/header.php");
		}
	?>
