...
function create_postulaciones() {
    register_post_type( 'postulaciones',
        array(
          'labels' => array(
            'name' => __( 'Postulaciones' ),
            'singular_name' => __( 'Postulaciones' )
          ),
        'public' => true,
        'menu_position' => 2,
...
function FESaddpost_id($document, $post){
    ...
    $document['_source']['site']['id'] = "www.uddventures.cl/alumnos";
    $document['_source']['site']['url'] = "http://www.uddventures.cl/alumnos";
    $document['_source']['site']['name'] = "UDD Ventures - Alumnos";
